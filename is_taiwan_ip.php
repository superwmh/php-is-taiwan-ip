...
function is_taiwan_ip($ip) {
  ...
  if (($longip>=978714624 AND $longip<=978780159)
    ...
    OR ($longip>=1024376512 AND $longip<=1024376703)
    ...
    OR ($longip>=1886994432 AND $longip<=1887006719)
    OR ($longip>=1887008768 AND $longip<=1887010815)
    ...
    OR ($longip>=2113684480 AND $longip<=2113684527)
    ...
    OR ($longip>=2258598592 AND $longip<=2258598623)
    ...
    OR ($longip>=3394861568 AND $longip<=3394862079)
    ...
    OR ($longip>=3412033536 AND $longip<=3412066303)
    ...
    OR ($longip>=3412787200 AND $longip<=3412803583)
    ...
    OR ($longip>=3418401728 AND $longip<=3418401791)
    OR ($longip>=3418401904 AND $longip<=3418401919)
    OR ($longip>=3418401936 AND $longip<=3418401951)
    ...
    OR ($longip>=3418510592 AND $longip<=3418510847)
    OR ($longip>=3418511384 AND $longip<=3418511399)
